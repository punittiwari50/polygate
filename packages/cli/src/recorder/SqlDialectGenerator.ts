...
INSERT INTO PG_APP_ACCESS_CHANNEL (
    APP_ID, CHANNEL_TYPE, BASE_URL, LOGIN_URL, LOGIN_SUCCESS_URL_PATTERN, LOGIN_SUCCESS_COOKIE_NAME, SESSION_INJECTION_RULES, USER_ID_COOKIE_NAME
) VALUES (
...
WHEN NOT MATCHED THEN
    INSERT (
        APP_ID, CHANNEL_TYPE, BASE_URL, LOGIN_URL, LOGIN_SUCCESS_URL_PATTERN, LOGIN_SUCCESS_COOKIE_NAME, SESSION_INJECTION_RULES, USER_ID_COOKIE_NAME, CREATED_AT, UPDATED_AT
    ) VALUES (
        source.APP_ID,
        source.CHANNEL_TYPE,
        ${this.escapeString(app.baseUrl)},
